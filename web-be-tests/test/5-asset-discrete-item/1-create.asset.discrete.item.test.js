...
describe('1-create-asset-discrete-item', function () {

  this.timeout(5000);

  const ownerPartyId = "854757a6-8ae3-4a6a-ab41-c29479ad76a9";

  it('create asset discrete item', function (done) {

    const discreteItem = {
      name: "Some Product",
      description: "Some Product Description",
      serialNumber: "7895411547",
    ...
    api.post("/assets/assets")
      ...
      .end(function (err, res) {
        ...
        if (!err) {
          ...
          discreteItem.assetId = res.body.assetId;
          discreteItem.ownerPartyId = res.body.ownerPartyId;
          discreteItem.dateModified = res.body.dateModified;
        }
