...
describe('3-delete-asset-identifier-type', function () {
  ...
  it('delete asset identifier type', function (done) {
    api.delete("/assets/asset-identifier-types/" + identifierType.assetIdentifierTypeId)
