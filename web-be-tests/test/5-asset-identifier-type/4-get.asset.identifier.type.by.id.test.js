...
describe('4-get-asset-identifier-type-by-id', function () {
  ...
  it('get asset identifier type', function (done) {
    api.get("/assets/asset-identifier-types/" + assetIdentifierType.assetIdentifierTypeId)
