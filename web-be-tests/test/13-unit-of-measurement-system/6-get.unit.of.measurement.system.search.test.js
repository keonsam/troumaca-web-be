...
describe('6-get-unit-of-measurement-system-search', function () {

  this.timeout(5000);

  const ownerPartyId = "854757a6-8ae3-4a6a-ab41-c29479ad76a9";

  it('get unit of measurement system search', function (done) {
    let query = "System";
    api.get('/unit-of-measurements/unit-of-measurement-systems/search?q=' + query)
