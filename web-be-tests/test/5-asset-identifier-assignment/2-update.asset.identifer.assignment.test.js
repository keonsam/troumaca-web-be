...
describe('2-update-asset-identifier-assignment', function () {
  ...
  it('update asset category legal value', function (done) {
    assetCategoryLegalValue.description = "Nivea for ment";
    api.put("/assets/asset-identifier-assignments/" + assetCategoryLegalValue.assetCategoryLegalValueId)
