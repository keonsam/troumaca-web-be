...
describe('4-get-asset-identifier-assignment-by-id', function () {
  ...
  it('get asset category legal value', function (done) {
    api.get("/assets/asset-identifier-assignments/" + assetCategoryLegalValue.assetCategoryLegalValueId)
