...
describe('2-update-asset-structure', function () {
  ...
  it('update asset structure', function (done) {
    assetIdentifierType.description = "Warriors Home Court";
    api.put("/assets/asset-structures/" + assetIdentifierType.assetIdentifierTypeId)
