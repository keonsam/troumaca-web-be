...
describe('1-create-asset-category-legal-value', function () {
  ...
  it('create asset asset category legal value', function (done) {
    ...
    api.post("/assets/asset-category-legal-values")
