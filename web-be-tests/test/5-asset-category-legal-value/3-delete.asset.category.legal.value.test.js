...
describe('3-delete-asset-category-legal-value', function () {
  ...
  it('delete asset asset category legal value', function (done) {
    api.delete("/assets/asset-category-legal-values/" + assetCategoryLegalValue.assetCategoryLegalValueId)
