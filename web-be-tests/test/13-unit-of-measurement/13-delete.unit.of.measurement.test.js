...
describe('13-delete-unit-of-measurement', function () {
  ...
  it('delete unit of measurement', function (done) {

    api.delete("/unit-of-measurements/" + unitOfMeasurementDimension.unitOfMeasurementId)
