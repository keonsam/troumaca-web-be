...
export function createAssetCharacteristicRepository(kind?: RepositoryKind): AssetCharacteristicRepository {
  ...
  switch (k) {
    ...
    default:
      throw new Error(`Unknown Asset Characteristic Repository ${k}`);
  }
