import {createOrganizationRepository} from "../../../infrastructure/party/organization.data.provider.factory";
...
export class OrganizationOrchestrator {
  ...
  private organizationRepository: OrganizationDataProvider;
