...
export class NedbCredentialDataProvider implements CredentialDataProvider {
    ...
    private addCredentialLocal(registerInput: RegisterRequest): Observable<CreatedCredential> {
        const response = new CreatedCredential();
        // const credential = new CreatedCredential(registerInput.username, registerInput.organizationName, registerInput.password);
