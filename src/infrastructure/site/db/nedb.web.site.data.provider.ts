...
export class NedbWebSiteDataProvider implements WebSiteDataProvider {
...
// class WebSiteRestRepository implements WebSiteDataProvider {
//
//   deleteWebSite(siteId: string): Observable<number> {
//     return undefined;
//   }
...
// export function createWebSiteRepository(kind?: RepositoryKind): WebSiteDataProvider {
//   switch (kind) {
