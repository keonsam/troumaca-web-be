...
export class NedbAssetCharacteristicDataProvider implements AssetCharacteristicDataProvider {

    addAssetCharacteristic(assetCharacteristicRequest: AssetCharacteristicRequest, headerOptions?: HeaderBaseOptions): Observable<AssetCharacteristic> {
        const assetCharacteristic: AssetCharacteristic = mapObjectProps(assetCharacteristicRequest, new AssetCharacteristic());
