...
export class NedbDepreciationDataProvider implements DepreciationDataProvider {
  ...
  getDepreciableAssets(searchStr: string, pageSize: number): Observable<Asset[]> {
    ...
    //         return this.assetDataProvider.findAssets(searchStr, pageSize)
    //             .pipe(map( assets => {
  ...
  getBookDepreciationArr(pageNumber: number, pageSize: number, order: string): Observable<Depreciation[]> {
    ...
    //       }
    //     });
    //     return this.assetDataProvider.getAssetsByIds(assetIds)
  ...
  getDepreciationById(depreciationId: string, type: string): Observable<Depreciation> {
    ...
    //     } else {
    //       return this.assetDataProvider.getAssetById(depreciation.assetId)
    //         .pipe(map(asset => {
