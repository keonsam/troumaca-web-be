...
export let findAssetCharacteristics = (req: Request, res: Response) => {
    ...
    assetCharacteristicOrchestrator.findAssetCharacteristics(searchStr, pageNumber, pageSize, headerOptions)
...
export let getAssetCharacteristics = (req: Request, res: Response) => {
    ...
    assetCharacteristicOrchestrator.getAssetCharacteristics(number, size, sort, headerOptions)
        .subscribe(result => {
            res.status(200);
